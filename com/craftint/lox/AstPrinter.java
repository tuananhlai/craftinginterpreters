...
class RpnPrinter implements Visitor<String> {
    ...
    public static void main(String[] args) {
        Expr expression = new Binary(
                new Binary(new Expr.Literal(1), new Token(TokenType.PLUS, "+", null, 1), new Expr.Literal(2)),
                new Token(TokenType.STAR, "*", null, 1),
                new Binary(new Expr.Literal(4), new Token(TokenType.MINUS, "-", null, 1), new Expr.Literal(3)));
